...
const PhoneRegister = ({ navigation }) => {
  ...
  return (
    ...
    >
      ...
      />
      <View style={{ flexDirection: "row", width: "100%",  marginTop: 33,paddingHorizontal: 20, }}>
        <TouchableOpacity onPress={()=>navigation.navigate("Register")} style={{ width: "50%" }}>
      ...
      <Text style={styles.txtFormName}>Mobile Number Registration</Text>
